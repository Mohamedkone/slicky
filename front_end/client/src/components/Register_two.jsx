  ...
  return (
      <div className='register2'>
          ...
          <div className='r-verify'>
            <button className='r-v-email r-btn'>Verify Email Account</button>
            <button className='r-v-number r-btn'>Verify Phone Number</button>
          </div>
          <div className="r-send-code">
              ...
              <button className='r-s-code r-btn'>Send code</button>
          </div>
          <div className="r-received-code">
              <input type='number' maxLength="5"/>
              <button className='r-v-code r-btn'>Verify</button>
          </div>
